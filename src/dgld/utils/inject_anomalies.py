...
def inject_structural_anomalies(graph, p, q, seed=42):
    ...
    print("inject structural_anomalies numbers:", len(structural_anomalies))
...
def inject_contextual_anomalies(graph, k, p, q, seed=42):
    ...
    attribute_anomalies_idx = np.random.choice(normal_nodes_idx,
                                               size=attribute_anomalies_number,
                                               replace=False)
