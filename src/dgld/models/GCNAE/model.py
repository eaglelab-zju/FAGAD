...
class GCN(nn.Module):
    ...
    def __init__(self, in_feats, n_hidden, out_feats, n_layers, dropout,
        ...
        self.layers.append(
            GraphConv(n_hidden, out_feats, bias=False, activation=None))
...
class GCNAEModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.net = GCN(feat_size, hidden_dim, feat_size, n_layers, dropout,
                       act)
...
class GCNAE(nn.Module):
    ...
    def __init__(self,
        ...
        self.model = GCNAEModel(feat_size,
                                hidden_dim,
                                n_layers,
                                dropout,
                                act=act)
            ...
            for epoch in range(num_epoch):
                ...
                for i, (input_nodes, output_nodes,
                    ...
                    train_loss = torch.mean(
                        self.loss_func(features[output_nodes], x_hat))
