    ...
    def fit(
        ...
        if batch_size == 0:
            ...
            for epoch in range(num_epochs):
                ...
                loss = (lbda * (low_kl_loss + hyper_loss) +
                ...
                self.eval()
                with torch.no_grad():
                    _, dist_score = self.getDistanceToClusters(low_emb)
...
# CUDA_VISIBLE_DEVICES=1 nohup python -u -m dgld.models.SCAD.models_gcn > ../logs/SCAD/gcn_Amazon_1124.log 2>&1 &
