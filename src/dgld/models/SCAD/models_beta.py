...
if __name__ == "__main__":
    ...
    data_path = "dgld/data"
    save_path = "dgld/models/SCAD/results/beta_1124.csv"
    runs = 1
...
# CUDA_VISIBLE_DEVICES=0 nohup python -u -m dgld.models.SCAD.models_beta > ../logs/SCAD/beta_1124.log 2>&1 &
