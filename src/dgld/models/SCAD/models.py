...
class SCAD(nn.Module):
    ...
    def get_hyper_loss(self, x, gamma):
        ...
        loss = torch.mean(self.radius**2) + (1 / gamma) * torch.mean(
...
if __name__ == "__main__":
    ...
    data_path = "dgld/data"
    save_path = "dgld/models/SCAD/results/results_0229.csv"
    runs = 5
...
# CUDA_VISIBLE_DEVICES=0 nohup python -u -m dgld.models.SCAD.models > ../logs/SCAD/elliptic_0229.log 2>&1 &
