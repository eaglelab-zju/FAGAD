    ...
    def fit(
        ...
        if batch_size == 0:
            ...
            for epoch in range(num_epochs):
                ...
                loss = lbda * (hyper_loss) + (1 - lbda) * recon_loss.mean()
                optimizer.zero_grad()
                loss.backward()
                optimizer.step()
...
if __name__ == "__main__":
    ...
    data_path = "dgld/data"
    save_path = "dgld/models/SCAD/results/no_comm_all_1122.csv"
    runs = 5
...
# CUDA_VISIBLE_DEVICES=1 nohup python -u -m dgld.models.SCAD.models_nocomm > ../logs/SCAD/no_comm_all_1122.log 2>&1 &
