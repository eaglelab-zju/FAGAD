...
from .colautils import test_epoch
from .colautils import train_epoch
...
class CoLA:
    ...
    def fit(
        ...
        for epoch in range(num_epoch):
            ...
            loss_accum = train_epoch(epoch, train_loader, self.model, device,
    ...
    def predict(self,
        ...
        for rnd in range(auc_test_rounds):
            ...
            predict_score = test_epoch(rnd, test_loader, self.model, device,
                                       self.criterion)
