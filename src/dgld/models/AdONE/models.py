...
from .adone_utils import random_walk_with_restart
from .adone_utils import test_step
from .adone_utils import train_step
...
class AdONE:
    ...
    def __init__(
        ...
        self.model = AdONE_Base(feat_size, num_nodes, embedding_dim,
    ...
    def fit(
        ...
        optim_all = torch.optim.Adam(self.model.parameters(),
                                     lr=lr_all,
                                     weight_decay=weight_decay)
        optim_disc = torch.optim.Adam(self.model.discriminator.parameters(),
                                      lr=lr_disc,
                                      weight_decay=weight_decay)
    ...
    def predict(
        ...
        predict_score = test_step(self.model, graph, adj, batch_size, betas,
                                  device)
