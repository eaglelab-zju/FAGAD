...
from .conad_utils import test_step
from .conad_utils import test_step_batch
from .conad_utils import train_step
from .conad_utils import train_step_batch
...
class CONAD(nn.Module):
    ...
    def fit(
        ...
        transform = KnowledgeModel(
            rate=rate,
            num_added_edge=num_added_edge,
            surround=surround,
